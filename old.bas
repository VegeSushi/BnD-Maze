...
__Enemy_Back
    if enemy_dir = 1 then player1y = player1y + 1
    if enemy_dir = 3 then player1y = player1y - 1
    if enemy_dir = 2 then player1x = player1x - 1
    if enemy_dir = 4 then player1x = player1x + 1
    enemy_dir = (rand&3) + 1
    return
